...
#SBATCH --output=logs/nlp4neuro_exp_4_%j.out # Standard output file (%j will be replaced by the job ID)
#SBATCH --error=logs/nlp4neuro_exp_4_%j.err  # Standard error file
