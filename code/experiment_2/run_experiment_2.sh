...
#SBATCH --output=logs/nlp4neuro_exp_2_%j.out # Standard output file (%j will be replaced by the job ID)
#SBATCH --error=logs/nlp4neuro_exp_2_%j.err  # Standard error file
